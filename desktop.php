...
$sql = "SELECT * FROM wallpapers WHERE device = 'desktop' ORDER BY date_uploaded DESC";
...
<?php render("head", $config['name'] . " : Get High-Quality PC Wallpapers Free"); ?>
...
<body class="bg-base-100" data-theme="light">
    ...
    <div class="hero h-[250px] " style="background-image: url(img/l.svg);">
        <div class="hero-content text-center">
            <div class="max-w-lg">
                <h1 class="text-5xl font-bold bg-base-100 p-4 rounded-md">All Desktop Wallpapers</h1>
            </div>
        </div>
    </div>
